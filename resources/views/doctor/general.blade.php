                    ...
                    <div class="p-4 border rounded">
                        <form class="row g-3" action="" method="post">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <textarea class="form-control" id="yourAppetite" rows="2"
                                                  name="appetite" >{{ $data ? $data->physical_complexion : '' }}</textarea>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="nav--card-btn py-4">
                                @if($pid)
                                    <a href="{{ url('makeup') }}?id={{ $pid }}" id="display1"
                                       class="display nex-pre-btn btn btn-warning px-4 me-4">Prev</a>
                                    <button class="btn btn-success" type="submit">Update</button>
                                    <a href="{{ url('birth') }}?id={{ $pid }}" id="display"
                                       class="display nex-pre-btn btn btn-info px-4">Next</a>
                                @else
                                    <a href="{{ url('makeup') }}" id="display1"
                                       class="display nex-pre-btn btn btn-warning px-4 me-4">Prev</a>
                                    <button class="btn btn-success" type="submit">Update</button>
                                    <a href="{{ url('birth') }}" id="display"
                                       class="display nex-pre-btn btn btn-info px-4">Next</a>
                                @endif
