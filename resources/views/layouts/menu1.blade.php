    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border" role="navigation" data-menu="menu-wrapper" data-menu-type="floating-nav" style="margin: -3.7rem 2rem 0;">
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item {{ request()->is('/') ? 'active' : '' }}" data-menu="dropdown"><a class="nav-link d-flex align-items-center" href="{{ url('/') }}"><i data-feather="home"></i><span data-i18n="Dashboards">Warranty Support</span></a>
                </li>

                <li class="nav-item {{ request()->is('registration') ? 'active' : '' }}" data-menu="dropdown"><a class="nav-link d-flex align-items-center" href="{{ url('/registration') }}"><i data-feather="bar-chart-2"></i><span data-i18n="Authentication">Warranty Registration</span></a>
                </li>
