                        ...
                        <div class="col-md-12 col-12">
                            <div class="card" style="margin: 20px;">
                                <div class="card-header" style="text-align:center">
                                    <h4 class="card-title" style="text-align:center">Warranty Registration</h4>
                                </div>
                                <div class="card-body" style="margin: 20px;">
                                    <form class="needs-validation" method="POST" action="<?php echo e(url('storecustomer1')); ?>" id="form">
                                        <?php echo csrf_field(); ?>
                                        <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\APPS\htdocs\laravel\resources\views/warantee.blade.php ENDPATH**/ ?>