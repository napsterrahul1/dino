            ...
            <div class="card-body">
                <div class="p-3 border rounded">
                    ...
                    <div class="next_prev_div">
                        ...
                        <form class="row g-3">
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" id="Built" rows="2"></textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="addComplexion" class="form-label">Complexion</label>
                                <textarea class="form-control" id="addComplexion" rows="2"></textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="Discoloration" class="form-label">Discoloration/ Pigmentation</label>
                                <textarea class="form-control" id="Discoloration" rows="2"></textarea>
                            </div>
                        </form>
                        <hr>
                        <h5>Appetite</h5>
                        <form class="row g-3">
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" id="yourAppetite" rows="2"></textarea>
                            </div>
                            <div class="col-md-4">
                        ...
                        <form class="row g-3">
                            <div class="col-md-4">
                                <label for="feelThirsty" class="form-label">Do you feel thirsty? (As a habit you drink / Is it that you drink only during your meals and you don’t feel thirsty in between.)</label>
                                <textarea class="form-control" id="feelThirsty" rows="2"></textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="waterDrink" class="form-label">How much water do you drink in the whole day?   </label>
                        ...
                        <form class="row g-3">
                            <div class="col-md-4">
                                <label for="reheatTheFood" class="form-label">Do you ask to reheat the food if it is in Room Temperature ?</label>
                                <textarea class="form-control" id="reheatTheFood" rows="2"></textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="dislikeFood" class="form-label">A complete dislike to anything particular in food?</label>
                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="yourStool1" value="">
                                        <label class="form-check-label" for="yourStool1">Smooth</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="yourStool2" value="">
                                        <label class="form-check-label" for="yourStool2">Hard</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="yourStool3" value="" >
                                        <label class="form-check-label" for="yourStool3">Any Other</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label for="characterStool" class="form-label">Character of Stool (odour/Color)</label>
                            ...
                            <div class="col-md-3">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="bowelHabits1" value="">
                                        <label class="form-check-label" for="bowelHabits1">Regular</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="bowelHabits2" value="">
                                        <label class="form-check-label" for="bowelHabits2">Irregular</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="bowelHabits3" value="" >
                                        <label class="form-check-label" for="bowelHabits3">Satisfactory</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="bowelHabits4" value="" >
                                        <label class="form-check-label" for="bowelHabits4">Unsatisfactory</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label for="troublePassingStool" class="form-label">Do you have any trouble before, during and after passing stool ?</label>
                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label for="characterUrine" class="form-label">Character of Urine(odour/Color)</label>
                                <textarea class="form-control" id="characterUrine" rows="2"></textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="troubleDuringUrine" class="form-label">Do you have any trouble before, during & after passing urine?</label>
                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="odourLike1" value="">
                                        <label class="form-check-label" for="odourLike1">Offensive</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="odourLike2" value="">
                                        <label class="form-check-label" for="odourLike2">Sour</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="odourLike3" value="" >
                                        <label class="form-check-label" for="odourLike3">Sweetish</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="odourLike4" value="" >
                                        <label class="form-check-label" for="odourLike4">Urine-like </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="odourLike5" value="" >
                                        <label class="form-check-label" for="odourLike5">Pungent</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="odourLike6" value="" >
                        ...
                        <form class="row g-3">
                            <div class="col-md-4">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="qualitySleep1" value="">
                                        <label class="form-check-label" for="qualitySleep1">Sound</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="qualitySleep2" value="">
                                        <label class="form-check-label" for="qualitySleep2">Alert</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="qualitySleep3" value="" >
                                        <label class="form-check-label" for="qualitySleep3">Restless</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="qualitySleep4" value="" >
                                        <label class="form-check-label" for="qualitySleep4">Continuous tossing about</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="qualitySleep5" value="" >
                            ...
                            <div class="col-md-4">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="activitySleep1" value="">
                                        <label class="form-check-label" for="activitySleep1">Salivation during sleep  </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="activitySleep2" value="">
                                        <label class="form-check-label" for="activitySleep2">Catnap Sleep </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="activitySleep3" value="" >
                                        <label class="form-check-label" for="activitySleep3">Talking</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="activitySleep4" value="" >
                                        <label class="form-check-label" for="activitySleep4">Walking</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="activitySleep5" value="" >
                                        <label class="form-check-label" for="activitySleep5">Snore</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="activitySleep6" value="" >
                                        <label class="form-check-label" for="activitySleep6"> Grind Teeth </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="activitySleep7" value="" >
                                        <label class="form-check-label" for="activitySleep7"> Weeping </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="activitySleep8" value="" >
                            ...
                            <div class="col-md-4">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="positionSleep1" value="">
                                        <label class="form-check-label" for="positionSleep1">Back</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="positionSleep2" value="">
                                        <label class="form-check-label" for="positionSleep2">Abdomen</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="positionSleep3" value="" >
                                        <label class="form-check-label" for="positionSleep3">Left Lateral   </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="positionSleep4" value="" >
                                        <label class="form-check-label" for="positionSleep4">Right Lateral</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="positionSleep5" value="" >
                                        <label class="form-check-label" for="positionSleep5">Knee Chest  </label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label for="coverInSleep" class="form-label">How much do you cover in sleep?</label>
                                <input class="form-control" id="coverInSleep">
                            </div>
                            <div class="col-md-4">
                                <label for="describeDream" class="form-label">Describe your Dreams: (good/bad)</label>
                                <textarea class="form-control" id="describeDream" rows="2"></textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="repeatedDream" class="form-label">Repeated dreams if any, describe it:</label>
                        ...
                        <form class="row g-3">
                            <div class="col-md-3">
                                <label for="exampleFormControlTextarea1" class="form-label">What type of climate/ Weather can you tolerate?</label>
                                <br>
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="climateTolerate1" value="">
                                        <label class="form-check-label" for="climateTolerate1">Cool</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="climateTolerate2" value="">
                                        <label class="form-check-label" for="climateTolerate2">Colder</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="climateTolerate3" value="" >
                                        <label class="form-check-label" for="climateTolerate3">Warm </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="climateTolerate4" value="" >
                                        <label class="form-check-label" for="climateTolerate4">Hot</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <label for="thermalTolerance" class="form-label">Thermal tolerance between cool / colder temp and warm / hot temperatures as in what you CAN TOLERATE more compared to others:</label>
                                <textarea class="form-control" id="thermalTolerance" rows="2"></textarea>
                                <small>(e.g:-Say in cold temperature you are the one who is feeling more cold or you are the one who comments it is not that cold and you require less woolen coverings in cold weather compared to others / Infact in slight cold weather also you are the one saying it is so cold & pile up with many layers of clothing.) [Think over this as it is important to know this answer as its shows the thermo equilibrium of the patient]</small>
                            </div>
                            <div class="col-md-4">
                        ...
                        <form class="row g-3">
                            <div class="col-md-4">
                                <label for="typeOfClothing" class="form-label">What type of clothing do you prefer ? </label>
                            ...
                            <div class="col-md-4">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity1" value="">
                                        <label class="form-check-label" for="sensitivity1">Sound/Music</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity2" value="">
                                        <label class="form-check-label" for="">Perfumes/Strong Odours</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity3" value="" >
                                        <label class="form-check-label" for="">Noise </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity4" value="" >
                                        <label class="form-check-label" for="">Allergic Reaction</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity5" value="" >
                                        <label class="form-check-label" for="">Touch</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity6" value="" >
                                        <label class="form-check-label" for="">Travelling Sickness</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity7" value="" >
                                        <label class="form-check-label" for="">Light</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity8" value="" >
                                        <label class="form-check-label" for="">Motion Sickness</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity9" value="" >
                                        <label class="form-check-label" for="">Sun</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity10" value="" >
                                        <label class="form-check-label" for="">Tight Clothing</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="sensitivity11" value="" >
                            ...
                            <div class="col-md-4">
                                <label for="superNaturalWorld" class="form-label">SuperNatural World (Extra Sensory Perceptions)</label>
                        ...
                        <form class="row g-3">
                            <div class="col-md-4">
                                <label for="describeSpeed" class="form-label">Mentally and Physically:(Before the disease, Describe your basic speed</label>
                        ...
                        <form class="row g-3">
                            <div class="col-md-4">
                                <label for="birthMark" class="form-label">Do you have any birthmarks, moles, Injury scars; if yes what age?</label>
                                <textarea class="form-control" id="birthMark" rows="2"></textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="birthMarkSide" class="form-label">Which part of the body and which Side (Right or Left)?</label>
                    ...
                    <div class="nav--card-btn py-4">
                        <?php if($pid): ?>
                        <a href="<?php echo e(url('makeup')); ?>?id=<?php echo e($pid); ?>" id="display1" class="display nex-pre-btn btn btn-warning px-4 me-4">Prev</a>
                        <button class="btn btn-success" type="submit">Update</button>
                        <a href="<?php echo e(url('birth')); ?>?id=<?php echo e($pid); ?>" id="display" class="display nex-pre-btn btn btn-info px-4">Next</a>
                        <?php else: ?>
                        <a href="<?php echo e(url('makeup')); ?>" id="display1" class="display nex-pre-btn btn btn-warning px-4 me-4">Prev</a>
                        <button class="btn btn-success" type="submit">Update</button>
                        <a href="<?php echo e(url('birth')); ?>" id="display" class="display nex-pre-btn btn btn-info px-4">Next</a>
                        <?php endif; ?>
