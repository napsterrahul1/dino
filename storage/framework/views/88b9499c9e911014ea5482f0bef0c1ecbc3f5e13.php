...
<div class="modal modal-slide-in fade" id="modals-slide-in">
    <div class="modal-dialog sidebar-xlg">
        <form class="add-new-record modal-content pt-0" method="POST" action="<?php echo e(url('permission/create')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\server\htdocs\e-expense-portal\resources\views/permissions/index.blade.php ENDPATH**/ ?>