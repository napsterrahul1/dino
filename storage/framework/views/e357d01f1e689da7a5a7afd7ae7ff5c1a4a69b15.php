        ...
        <div class="content-body">
            ...
            <section id="basic-datatable">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <table class="reimbursement-datatables table">
                                <thead>
                                    <tr>
                            ...
                            <div class="modal-body flex-grow-1">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="select2 form-control" id="claim_type">
                                            ...
                                            <option value="8">Relocation Expense Advance.</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 outing" style="display: none;">
                                        ...
                                        <input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname" placeholder="1" aria-label="John Doe" />
                                    </div>

                                    <div class="form-group col-md-6 outing" style="display: none;">
                                        <label class="form-label" for="basic-icon-default-fullname">Employees</label>
                                        <input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname" placeholder="Rahul Tathod, SHarad Gayakwad,Rahul Sailwal" aria-label="John Doe" />
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\server\htdocs\e-expense-portal\resources\views/reimbursement/index.blade.php ENDPATH**/ ?>