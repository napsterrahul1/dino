            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="user-info ps-3">
                        <p class="user-name mb-0"><?php echo e($user->name); ?></p>
                        <p class="designattion mb-0">Dashboard</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="<?php echo e(url('/home')); ?>"><i class='bx bx-home-circle'></i><span>Dashboard</span></a>
                    </li>
                    
                    <li>
                        <div class="dropdown-divider mb-0"></div>
                    </li>
                    <li><a class="dropdown-item" href="<?php echo e(url('logout')); ?>"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>
...
<?php /**PATH C:\xampp\htdocs\anup\resources\views/layouts/menu.blade.php ENDPATH**/ ?>