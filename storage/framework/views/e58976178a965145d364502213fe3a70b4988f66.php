<link rel="apple-touch-icon" href="<?php echo e(asset('app-assets/images/logo/favicon.png')); ?>">
<link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('app-assets/images/logo/favicon.png')); ?>">
...
<?php /**PATH D:\server\htdocs\e-expense-portal\resources\views/layouts/head.blade.php ENDPATH**/ ?>